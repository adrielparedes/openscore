...
import { deletePersonalCard } from "@/actions/usuarios";
...
export default function PersonalCardUpload({ currentCard }: Props) {
    ...
    <div className="flex flex-col gap-4">
      {preview ? (
        <div className="relative group">
          <div className="relative w-full aspect-[3/2] rounded-xl overflow-hidden border border-slate-200 bg-slate-50 shadow-sm">
            <Image
              src={preview}
              alt="Personal card"
              fill
