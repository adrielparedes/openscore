...
export async function logoutAction() {
  return recordAction("logoutAction", async () => {
    await signOut({ redirectTo: "/login" });
  });
}

export async function registerAction(formData: FormData) {
  return recordAction("registerAction", async () => {
...
export async function getPreguntasSecretas() {
  return recordAction("getPreguntasSecretas", async () => {
...
export async function getForgotPasswordQuestion(formData: FormData) {
  return recordAction("getForgotPasswordQuestion", async () => {
...
export async function resetPasswordAction(formData: FormData) {
  return recordAction("resetPasswordAction", async () => {
    const email = (formData.get("email") as string | null)?.trim();
