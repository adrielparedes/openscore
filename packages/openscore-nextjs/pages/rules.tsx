    ...
    <div>
      ...
      <div className="reglas">
        ...
        <div>
          ...
          until the day before the final match. Points will be awarded only for
          the matches for which predictions were entered, and, in consequence: 0
          (ZERO) points will be awarded for matches with no predictions entered.
        </div>
        <div>
          <b>4.</b> Copa América consists of <b>28 matches</b>, of which: 20 are
          in the initial group stage, 4 in quarter-finals, 2 in semi-finals, 1
          for 3rd place and 1 final match.
        </div>
        <div>
        ...
        <div>
          <b>6.</b> For the predictions on quarter finals until the final match,
          the 90 minutes of the match plus the additional time, if any, and
        ...
        <div>
          ...
          <b>3 (THREE)</b> points per correct predicition (Local, Tie, Visitor).
        </div>
        <div>
        ...
        <div>
          <b>12.</b> There will be <b>three winners in each sub-region</b> (the
          top three): 3 (THREE) winners in Argentina/SolaEast, 3 (THREE) winners
