    ...
    <div>
      ...
      <div className="reglas">
        <ul className="reglas__content">
          ...
          <li>
            Only Red Hat associates from <b>Argentina/SolaEast</b>,<b>Brazil</b>
            , <b>Chile</b>, <b>Peru</b>, <b>Colombia/CEACA</b> and
            <b>Mexico</b> can participate, using the corporate e-mail address.
          </li>
          <li>
            Participants may register any time during Copa América and until the
          ...
          <li>
            Copa América consists of <b>28 matches</b>, of which: 20 are in the
            initial group stage, 4 in quarter-finals, 2 in semi-finals, 1 for
          ...
          <li>
            Scoring for each match in the group stage will be of
            <b>1 (ONE)</b> point per correct prediction (Local, Tie, Visitor).
          </li>
          <li>
            Scoring for each match in quarter-finals will be
            <b>2 (TWO)</b> points per correct prediction (Local, Tie, Visitor).
          </li>
          <li>
            Scoring for each match in semi-finals will be of
